...
| No introduced abstraction is unused | All four architecture tests pass; the source audit found no orphan event, dead bus, empty production interface, unused machine, or placeholder production path. |
